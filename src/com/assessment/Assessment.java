...
public class Assessment {
	...
	public static String[][] xData,write;

	public static void main(String[] args) throws Exception {
		xlRead("C:\\Users\\bmarthala\\Documents\\YahooDDF.xls");
		for (int i = 1; i < xlRows; i++) 
		{	
			if((xData[i][1]).equalsIgnoreCase("y")){
			String data = xData[i][0];
			System.setProperty("webdriver.chrome.driver", "C:\\Softwares\\chromedriver.exe");
			WebDriver driver = new ChromeDriver();
			driver.manage().window().maximize();
			driver.get("https://in.yahoo.com/");
			driver.findElement(By.id("uh-search-box")).sendKeys(data);
			Thread.sleep(2000);
		...
		xlwrite("C:\\Users\\bmarthala\\Documents\\YahooDDF.xls",xData);
	}
